...
namespace DPMOPS.Data.Migrations
{
    ...
    [Migration("20250511142254_RemoveBirthDate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DPMOPS.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("DPMOPS.Models.Employee", b =>
                {
                    b.HasOne("DPMOPS.Models.ApplicationUser", "Account")
                        .WithOne("Employee")
                        .HasForeignKey("DPMOPS.Models.Employee", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DPMOPS.Models.ServiceRequest", b =>
                {
                    ...
                    b.HasOne("DPMOPS.Models.Employee", "Employee")
                        .WithMany("ServiceRequests")
